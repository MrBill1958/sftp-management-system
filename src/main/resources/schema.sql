...
VALUES ('ADMIN', 'Full system administrators'),
...
INSERT INTO application_config (config_key, config_value, description, encrypted)
VALUES ('DB_INITIALIZED', 'true', 'Database initialization flag', FALSE),
